layui.use('table', 'util', function(){
    ...
    var tableIns = table.render({
        ...
        ,cols: [[
            ...
            ,{field:'arcTypeName', title:'所属类别', width:100, templet: "#arcTypeTpl"}
            ,{field:'points', title:'积分', width:80, sort: true, templet: "#pointsTpl"}
            ,{field:'publishDate', title:'发布日期', width:177, sort: true,templet: layui.each(d.articleList,function (index,item) {
                   "<div> {{util.toDateString(item.publishDate,'yyyy-MM-dd HH:mm:ss')}}</div>"
